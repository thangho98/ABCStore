            ...
            <div class="hero-static d-flex align-items-center">
                <div class="w-100">
                            ...
                            <div class="col-md-8 col-lg-6 col-xl-4 py-4">
                                ...
                                <div class="text-center">
                                    ...
                                    <h2 class="h6 font-w400 text-muted mb-3">
                                        Vui lòng cung cấp tài khoản email của bạn và chúng tôi sẽ gửi cho bạn mật khẩu
                                        của bạn.
                                    </h2>
                                </div>
                                <!-- END Header -->
                                    ...
                                    <div class="form-group row justify-content-center">
                                        <div class="col-md-6 col-xl-5">
                                            <button type="submit" class="btn btn-block btn-primary">
                                                <i class="fa fa-fw fa-envelope mr-1"></i> Gửi thư
                                            </button>
                                        </div>
                                    </div>
                                    {{ csrf_field() }}
                                ...
                                <div class="text-center">
                                    <a class="font-size-sm" href="signin.html">Đăng nhập?</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="font-size-sm text-center text-muted py-3">
                        <strong>ABC Store</strong> &copy; <span data-toggle="year-copy"></span>
                    </div>
                    <!-- END Footer -->
                </div>
            </div>
