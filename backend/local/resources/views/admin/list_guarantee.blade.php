                ...
                <table class="table table-bordered table-striped table-vcenter" id="table-brand">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center orderby" style="width: 200px;">Tên Sản phẩm</th>
                            <th class="text-center d-sm-table-cell orderby remove-sorting"> Mô tả</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center d-sm-table-cell">
                                ...
                                <span class="badge badge-info">Recieved
                                    @elseif ($item->gtd_status == 1)
                                    <span class="badge badge-warning"> Doing
                                        @elseif ($item->gtd_status == 2)
                                        <span class="badge badge-primary"> Done
                                            @else <span class="badge badge-success"> Refunded
                                @endif </span>
                            </td>
                            <td class="text-right">
                                <div class="py-2 mb-2">
                                    ...
                                    <button type="button" class="btn btn-sm btn-warning" data-toggle="tooltip"
                                        onclick="showEdit({{$item->gtd_id}})" title="Sửa">
