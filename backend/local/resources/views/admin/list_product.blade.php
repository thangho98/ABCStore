                                        ...
                                        <tr id="image-row1">
                                            <td class="text-left">
                                                <img id="image-1" class="thumbnail"
                                                    src="{{asset('public/admin')}}/assets/media/img/new_seo-10-75.png" onclick="chooseImg(1);"
        ...
        <tr id="image-row${index}">
            <td class="text-left">
                <img id="image-${index}" class="thumbnail"
                    src="{{asset('public/admin')}}/assets/media/img/new_seo-10-75.png" onclick="chooseImg(${index});"
                    height="75px;" width="75px;">
