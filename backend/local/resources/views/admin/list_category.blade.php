...
<main id="main-container">
                ...
                <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-alt">
                        ...
                        <li class="breadcrumb-item" aria-current="page">
                            <a class="link-fx" href="">Danh mục</a>
                        </li>
                    </ol>
                </nav>
            </div>
    ...
    <div class="content">
        ...
        <div class="block">
            <form id="formdata" action="{{asset('admin/category/delete')}}" method="GET" enctype="multipart/form-data">
        ...
        <form action="{{asset('admin/category/add')}}" id="add-form" method="POST" novalidate>
            <div class="form-row">
                ...
                <div class="form-group mt-4 col-1">
                    <img id="image-icon" class="thumbnail" src="{{asset('public/admin')}}/assets/media/img/new_seo-10-75.png" onclick="chooseImg('icon');" height="50px;" width="50px;">
                </div>
            </div>
