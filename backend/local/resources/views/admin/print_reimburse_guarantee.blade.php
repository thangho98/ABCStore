                    ...
                    <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-alt">
                            ...
                            <li class="breadcrumb-item" aria-current="page">
                                <a class="link-fx" href="">Trả bảo hành</a>
                            </li>
                        </ol>
                    </nav>
                </div>
                    ...
                    <section class="invoice">
                        <div class="row mb-4 header-print">
                            ...
                            <div class="col-md-6 text-center">
                                <h1 class="text-danger hoadon-title">PHIẾU TRẢ BẢO HÀNH</h1>
                                <p> (Phần cửa hàng giữ) <br>
                                    (For Store)
                                </p>
                            </div>
                            <div class="col-md-2 offset-1">
                                <h5 class="text-left text-primary hoadon-date">
                                    ...
                                    <br> Ngày nhận: <span>{{ date("d/m/Y",strtotime($guarantee->gtd_date_receive))}}</span>
                        ...
                        <div class="row invoice-info mb-3">
                            ...
                            <div class="col-10">
                                ...
                                <br><span>{{ date("d/m/Y",strtotime($guarantee->gtd_date_reimburse))}}</span>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row mt-3">
                            <div class="col-3">
                                <p><strong>Nội dung bảo hành:</strong></p>
                            </div>
                            <div class="col-9">
                                <textarea readonly rows="3" cols="80">{{$guarantee->gtd_content}}</textarea>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-4">
                            ...
                            <div class="col-4 text-right">
                                <strong>Nhân viên trả</strong><br>
                                <small><b>(Ký, ghi rõ họ tên)</b></small>
                                <br><br><br><br><br>
