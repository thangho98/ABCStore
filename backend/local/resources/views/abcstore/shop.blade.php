    ...
    <div class="container">
        <div class="breadcrumb">
            <ul class="d-flex align-items-center">
                ...
                <li class="active"><a href="product.html">Cửa hàng</a></li>
            </ul>
        </div>
    </div>
    <!-- Container End -->
                        ...
                        <ul class="sidbar-style">
                            ...
                            <li class="form-check">
                                <input class="form-check-input" onclick="onClickHandler()" name="cate_id"
                                    value="{{$item->cate_id}}" id="{{$item->cate_id}}" type="checkbox">
                        ...
                        <ul class="sidbar-style" style="overflow-y: auto;">
                            ...
                            <li class="form-check">
                                <input class="form-check-input" onclick="onClickHandler()" name="brand_id"
                                    value="{{$item->brand_id}}" id="{{$item->brand_id}}" type="checkbox">
                        ...
                        <ul class="size-list sidbar-style">
                            ...
                            <li class="form-check">
                                <input class="form-check-input" onclick="onClickHandler()" name="ram"
                                    value="{{$item->propt_ram}}" id="ram{{$item->propt_ram}}" type="checkbox">
                        ...
                        <ul class="size-list sidbar-style">
                            ...
                            <li class="form-check">
                                <input class="form-check-input" onclick="onClickHandler()" name="rom"
                                    value="{{$item->propt_rom}}" id="rom{{$item->propt_rom}}" type="checkbox">
