        ...
        <div class="d-flex flex-wrap text-center">
            ...
            <div class="single-support">
                ...
                <div class="support-desc">
                    ...
                    <span>Giao hàng hoả tốc trong 1 giờ</span>
                </div>
            </div>
            <div class="single-support">
                <div class="support-icon">
            ...
            <div class="single-support">
                ...
                <div class="support-desc">
                    ...
                    <span>Hỗ trợ suốt thời gian sử dụng. Hotline: (+84) 328119182</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="footer-top">
        <div class="container">
            ...
            <div class="row mb-60">
                <div class="col-xl-7 col-lg-7 ml-auto mr-auto col-md-8">
                    <div class="news-desc text-center mb-30">
                        <h3>Đăng kí để nhận thêm thông báo mới</h3>
                        <p>Hãy là người đầu tiên biết. Đăng ký nhận bản tin ngày hôm nay</p>
                    </div>
                    <div class="newsletter-box">
                        <form action="#">
                            <input class="subscribe" placeholder="Nhập email của bạn..." name="email" id="subscribe"
                                type="text">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-footer mb-sm-40">
                        <h3 class="footer-title">Đường dây hỗ trợ</h3>
                        <div class="footer-content">
                            <ul class="footer-list">
                    ...
                    <div class="single-footer mb-sm-40">
                        ...
                        <div class="footer-content">
                            <ul class="footer-list address-content">
                                <li><i class="lnr lnr-map-marker"></i> Địa chỉ: Linh Trung, Thủ Đức, Tp.HCM</li>
                                <li><i class="lnr lnr-envelope"></i>Email: cskh@abcstore.com.vn</li>
                                <li>
                                    <i class="lnr lnr-phone-handset"></i> Tổng đài miễn phí: +(84) 328118182
                                </li>
                            </ul>
    ...
    <div class="footer-bottom pb-30">
        <div class="container">
            ...
            <div class="copyright-text text-center">
                <p>Bản quyền © 2019 <a target="_blank" href="#">ABCSTORE</a> Đã đăng ký Bản quyền.</p>
            </div>
        </div>
        <!-- Container End -->
    </div>
